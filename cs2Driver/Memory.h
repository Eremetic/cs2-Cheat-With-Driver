...
///for debug
typedef union _PTE_ADDRESS
{
	ULONG_PTR Address;
	struct
	{
		ULONG_PTR Valid : 1;
		ULONG_PTR pageFileIndex : 4;
		ULONG_PTR Protect : 5;
		ULONG_PTR Prototype : 1;
		ULONG_PTR Transition : 1;
		ULONG_PTR pageFileReserved : 1;
		ULONG_PTR pageFileAllocated : 1;
		ULONG_PTR reserved0 : 18;
		ULONG_PTR pageFileOffset : 32;

	}Bits;
}PTE_ADDRESS, * PPTE_ADDRESS;
